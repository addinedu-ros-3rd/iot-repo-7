...
## 프로젝트 설계
1. 가변 저항으로 사용자가 사료량을 설정하고
2. 압력센서로 사용자가 설정한 무게만큼 사료 배급
3. 가변저항으로 사용자가 사료 배급시간을 설정하고 정해진 시간이 됐을 때 사료 배급
4. 녹음 모듈을 활용해서 반려동물에게 배급시간임을 인지하게 함
5. LCD에 남은 시간, 사료량 조절 화면 디스플레이
...
### 아쉬운 점
1. 압력 센서가 민감하여 사료의 무게를 제대로 계산하지 못함
